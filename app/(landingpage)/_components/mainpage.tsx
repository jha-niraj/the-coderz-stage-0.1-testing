        ...
        >
            ...
            <div className="flex flex-col md:flex-row items-center justify-between gap-12">
                <div className="flex flex-col items-center justify-center gap-8 w-full">
                    <h1 className="text-4xl md:text-5xl flex flex-col gap-4 font-bold text-center leading-tight">
                        Your One-Stop Platform for
                        <Cover className="text-black dark:text-white bg-clip-text text-transparent bg-gradient-to-r from-blue-400 to-emerald-400">
