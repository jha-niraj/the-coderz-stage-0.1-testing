...
export default function ClientLayout({ children }: { children: React.ReactNode }) {
    ...
    return (
        <div
            className={cn(
                "flex flex-col bg-black dark:bg-dot-white/[0.2] bg-dot-white/[0.2] dark:bg-neutral-800 w-full flex-1 mx-auto dark:border-neutral-700 overflow-hidden"
            )}
        >
            <Toaster />
            ...
            <main className={`${open ? "pl-[200px]" : "md:pl-[60px]"} transition-all duration-300 bg-black dark:bg-dot-white/[0.2] bg-dot-white/[0.2] pt-12 md:pt-0`}>
                {
                    children
                }
                <Footer />
