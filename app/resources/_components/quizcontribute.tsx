...
export default function QuizAndContribute({ contributelink } : QuizAndContributeProps) {
    return (
        <section>
            ...
            >
                <h1 className="text-lg font-semibold text-center text-black">We are currently integrating the quiz application on this platform itself, till then please use this google form quiz for practice.</h1>
