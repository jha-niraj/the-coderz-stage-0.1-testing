...
export const lessonData = {
    'intro_cin_cout': {
        ...
        description: "Learn the basics of input and output in C++ using cin and cout.",
        sections: [
            {
                "title": "What is cout?",
                "content": "cout is an object of the ostream class used to output data to the standard output (usually the console). It is used with the insertion operator << to send data to the output stream.",
        ...
        int main() {
            ...
            {
                "title": "What is cin?",
                "content": "cin is an object of the istream class used to receive input from the standard input (usually the keyboard). It is used with the extraction operator >> to read data from the input stream.",
                "code": `#include <iostream>
        using namespace std;
        ...
        int main() {
            ...
            },
            {
                ...
                "content": "You can combine cin and cout to read and display data in a single program.",
                "code": `#include <iostream>
        using namespace std;
    ...
    'structs_unions_enums': {
        ...
        description: "Explore the use of structures, unions, and enumerations in C++ for organizing data.",
        sections: [
            {
                title: "What is a Structure?",
                content: "A structure is a user-defined data type that allows you to combine data items of different kinds.",
                code: `#include <iostream>
        using namespace std;
        ...
        int main() {
            ...
            },
            {
                ...
                content: "A union is similar to a structure, but it can store only one of its non-static data members at a time, saving memory.",
                code: `#include <iostream>
        using namespace std;
        ...
        int main() {
            ...
            },
            {
                ...
                content: "An enumeration is a user-defined data type that consists of integral constants, making code more readable.",
                code: `#include <iostream>
        using namespace std;
    ...
    'inline_memberfunc': {
        ...
        description: "Understand the difference between inline and non-inline member functions in C++.",
        sections: [
            {
                title: "What are Inline Functions?",
                content: "An inline function is a function that is expanded in line when it is called. This is a suggestion to the compiler to insert the function's body into the calling code to save time.",
                code: `#include <iostream>
        using namespace std;
        ...
        int main() {
            ...
            },
            {
                ...
                content: "Non-inline functions are defined outside the class and are called when invoked. They do not provide the performance benefits of inline functions.",
                code: `#include <iostream>
        using namespace std;
        ...
        int main() {
            ...
            {
                title: "Choosing Between Inline and Non-inline",
                content: "Use inline functions for small, frequently called functions, but be cautious with larger functions as they can increase the size of the binary.",
                code: ""
            }
        ],
        practiceQuestions: [
