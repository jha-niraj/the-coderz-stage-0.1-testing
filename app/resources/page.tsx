	...
	return (
		...
		>
			<div className="p-6 flex flex-col justify-between h-full">
				<div>
					<h2 className="text-2xl font-bold text-white mb-2">{resource.name}</h2>
...
export default function ResourcesPage() {
	...
	return (
		<SmoothScroll>
			<div className="min-h-screen pt-20 md:pt-8 text-white">
					...
					<AnimatePresence>
						...
						>
							...
							<div className="relative z-10 py-24 px-4 sm:px-6 lg:px-8">
								<h2 className="text-5xl font-extrabold mb-6 text-white shadow-text">Discover Resources</h2>
								<p className="text-xl text-gray-200 mb-8 max-w-3xl mx-auto shadow-text">
								...
								<div className="max-w-md mx-auto relative">
									<Input
										...
										className="w-full bg-black bg-opacity-100 text-white placeholder:text-white border-gray-500 focus:border-blue-300 focus:ring focus:ring-blue-200 focus:ring-opacity-50 rounded-full py-3 px-6 pr-12 shadow-inner"
									/>
					...
					<AnimatePresence>
						{filteredCategories.map((category, categoryIndex) => (
							<motion.section
								...
								className="mb-16"
							>
								<h2 className="text-3xl font-bold mb-4 flex items-center text-gray-100">
