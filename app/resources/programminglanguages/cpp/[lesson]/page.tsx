    ...
    return (
        <SmoothScroll>
            <div className="min-h-screen text-gray-800 py-12 px-4 sm:px-6 lg:px-8">
                ...
                >
                    <h1 className="text-4xl sm:text-5xl font-bold text-center text-white mb-4">{currentLesson.title}</h1>
                    <p className="text-lg text-gray-300 mb-8 text-center">{currentLesson.description}</p>
